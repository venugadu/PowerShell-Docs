...
[Sign
in](https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=13&ct=1481155775&rver=6.7.6640.0&wp=mcmbi&wlcxt=technet%24technet%24technet&wreply=https%3a%2f%2ftechnet.microsoft.com%2fen-us%2flibrary%2fjj592891%2528v%3dwps.630%2529.aspx&lc=1033&id=254354&mkt=en-us){.scarabLink}
...
<span
class="breadcrumbDropSmall">[<span>Get-PswaAuthorizationRule</span>](# "Get-PswaAuthorizationRule"){#tocDropDownButton}</span>
...
<span
class="breadcrumbDropSmall">[<span>Get-PswaAuthorizationRule</span>](# "Get-PswaAuthorizationRule"){#tocPopupButton}</span>
...
-   [Windows Server 2012 and Windows
    8](/en-us/library/jj592891(v=wps.620).aspx)
...
Get-PswaAuthorizationRule {#get-pswaauthorizationrule-1 .heading}
-------------------------
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_e7feb834-c437-4e45-8b7c-13fa95962183'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_e7feb834-c437-4e45-8b7c-13fa95962183"
...
-   **int\[\], String\[\]**
    ...
    This cmdlet accepts an array of integers or an array of string
    values as input.
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_9db8162d-737c-4f26-9c32-3302b8121f89'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_9db8162d-737c-4f26-9c32-3302b8121f89"
class="codeSnippetContainerCode" dir="ltr">
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_f2cee234-1331-4065-8266-14b5c4c11b4d'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_f2cee234-1331-4065-8266-14b5c4c11b4d"
class="codeSnippetContainerCode" dir="ltr">
...
This example illustrates how the cmdlet accepts a value from pipeline. A
rule id and a rule name are passed in this cmdlet.
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_2bd98a74-ff83-470f-8c8c-5fce6a7f078f'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_2bd98a74-ff83-470f-8c8c-5fce6a7f078f"
class="codeSnippetContainerCode" dir="ltr">
...
\
[Add-PswaAuthorizationRule](https://technet.microsoft.com/en-us/library/jj592890(v=wps.630).aspx)\
\
...
</span>](https://technet.microsoft.com/en-us/library/community/add/jj592891(v=wps.630).aspx){.communityContentAddLink}
...
data-url="/en-us/library/community/comments/jj592891(v=wps.630).aspx">
