...
[Sign
in](https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=13&ct=1481155781&rver=6.7.6640.0&wp=mcmbi&wlcxt=technet%24technet%24technet&wreply=https%3a%2f%2ftechnet.microsoft.com%2fen-us%2flibrary%2fjj592893%2528v%3dwps.630%2529.aspx&lc=1033&id=254354&mkt=en-us){.scarabLink}
...
<span
class="breadcrumbDropSmall">[<span>Remove-PswaAuthorizationRule</span>](# "Remove-PswaAuthorizationRule"){#tocDropDownButton}</span>
...
<span
class="breadcrumbDropSmall">[<span>Remove-PswaAuthorizationRule</span>](# "Remove-PswaAuthorizationRule"){#tocPopupButton}</span>
...
-   [Windows Server 2012 and Windows
    8](/en-us/library/jj592893(v=wps.620).aspx)
...
Remove-PswaAuthorizationRule {#remove-pswaauthorizationrule-1 .heading}
----------------------------
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_c9dae822-65ae-4b12-8a1a-d0d7e843d625'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_c9dae822-65ae-4b12-8a1a-d0d7e843d625"
...
-   **int\[\], PswaAuthorizationRule\[\]**
    ...
    This cmdlet accepts either an array of integers or an array of
    PswaAuthorizationRule objects.
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_89aa5d76-7c2f-48ba-bd8d-38c8442a337b'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_89aa5d76-7c2f-48ba-bd8d-38c8442a337b"
class="codeSnippetContainerCode" dir="ltr">
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_b4e0044a-1432-44b2-ae08-03028faa0b6b'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_b4e0044a-1432-44b2-ae08-03028faa0b6b"
class="codeSnippetContainerCode" dir="ltr">
...
</span>](https://technet.microsoft.com/en-us/library/community/add/jj592893(v=wps.630).aspx){.communityContentAddLink}
...
data-url="/en-us/library/community/comments/jj592893(v=wps.630).aspx">
