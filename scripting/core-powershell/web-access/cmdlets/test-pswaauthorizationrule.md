...
[Sign
in](https://login.live.com/login.srf?wa=wsignin1.0&rpsnv=13&ct=1481155783&rver=6.7.6640.0&wp=mcmbi&wlcxt=technet%24technet%24technet&wreply=https%3a%2f%2ftechnet.microsoft.com%2fen-us%2flibrary%2fjj592892%2528v%3dwps.630%2529.aspx&lc=1033&id=254354&mkt=en-us){.scarabLink}
...
<span
class="breadcrumbDropSmall">[<span>Test-PswaAuthorizationRule</span>](# "Test-PswaAuthorizationRule"){#tocDropDownButton}</span>
...
<span
class="breadcrumbDropSmall">[<span>Test-PswaAuthorizationRule</span>](# "Test-PswaAuthorizationRule"){#tocPopupButton}</span>
...
-   [Windows Server 2012 and Windows
    8](/en-us/library/jj592892(v=wps.620).aspx)
...
Test-PswaAuthorizationRule {#test-pswaauthorizationrule-1 .heading}
--------------------------
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_7fba7662-3b92-44db-a81f-be58ab890058'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_7fba7662-3b92-44db-a81f-be58ab890058"
...
for a specified user, computer, or endpoint. This cmdlet can also be
used to test authorization rules to validate that a particular user,
computer or endpoint access request is authorized.\
...
### -ConnectionUri&lt;Uri&gt; {#connectionuriuri .subHeading}
...
### -Rule&lt;PswaAuthorizationRule\[\]&gt; {#rulepswaauthorizationrule .subHeading}
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_80a25781-9abf-45df-a881-39ec727bf055'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_80a25781-9abf-45df-a881-39ec727bf055"
class="codeSnippetContainerCode" dir="ltr">
...
[Copy](javascript:if%20(window.epx.codeSnippet)window.epx.codeSnippet.copyCode('CodeSnippetContainerCode_f959a237-27af-4fd0-94f8-1b75ab741f1c'); "Copy to clipboard.")

</div>

</div>

<div id="CodeSnippetContainerCode_f959a237-27af-4fd0-94f8-1b75ab741f1c"
class="codeSnippetContainerCode" dir="ltr">
...
</span>](https://technet.microsoft.com/en-us/library/community/add/jj592892(v=wps.630).aspx){.communityContentAddLink}
...
data-url="/en-us/library/community/comments/jj592892(v=wps.630).aspx">
